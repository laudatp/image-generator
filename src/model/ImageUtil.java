...
public class ImageUtil {
   ...
   *
   * @param  filename    the full path of the image file. Look at the ImageIO class to see which
   ...
   * @param  filename    the full path of where the image must be stored. This should include the
